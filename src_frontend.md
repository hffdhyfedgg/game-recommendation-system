...
```json
{
  ...
  "packages": {
    ...
    "node_modules/@astrojs/alpinejs": {
      "version": "0.5.0",
      "resolved": "https://registry.npmjs.org/@astrojs/alpinejs/-/alpinejs-0.5.0.tgz",
      "integrity": "sha512-mORFY/ljzz6LPqkBPBd4v2i6yMhTkySgopIpVyKODEoJegp1PuX2Hri589P1oJzICGHSY8Q28OIyF/50Cf/lMQ==",
      "license": "MIT",
      "peerDependencies": {
...
export const gamesData = [
  {
    ...
    title: "Cyber Nexus",
    description:
      "Погрузитесь в мир киберпанка с захватывающим геймплеем и глубоким сюжетом. Сражайтесь с корпорациями и хакерами в мегаполисе будущего.",
    genres: ["Action", "RPG"],
    rating: 4.5,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/1abf2cde9-2f36-4b46-8f54-eb1b90da79ac.png",
  },
  {
    id: 2,
    title: "Mystic Realms",
    description:
      "Эпическое фэнтези приключение в волшебных мирах. Исследуйте древние руины, сражайтесь с монстрами и раскрывайте тайны магии.",
    genres: ["Adventure", "RPG"],
    rating: 4.8,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/165ec6999-579d-4c3b-bb0d-cc9bb4972cec.png",
  },
  {
    id: 3,
    title: "Galactic Command",
    description:
      "Стратегия в космосе с тактическими боями и дипломатией. Постройте свою империю среди звезд и защитите ее от врагов.",
    genres: ["Strategy", "Simulation"],
    rating: 4.2,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/15b8b4759-ca52-47d4-b3c6-c9895104b26b.png",
  },
  {
    id: 4,
    title: "Puzzle Quest",
    description:
      "Увлекательная головоломка с сотнями уровней и уникальными механиками. Развивайте логическое мышление и решайте сложные задачи.",
    genres: ["Puzzle", "Casual"],
    rating: 4.6,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/181af594a-a269-4377-92bc-2df0d874bfe7.png",
  },
  {
    id: 5,
    title: "Racing Legends",
    description:
      "Реалистичный автосимулятор с сотнями машин и треков со всего мира. Станьте чемпионом в захватывающих гонках.",
    genres: ["Racing", "Sports"],
    rating: 4.4,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/1ca7fb0e4-5458-44fe-8816-0b4d9832f951.png",
  },
  {
    id: 6,
    title: "Survival Island",
    description:
      "Выживание на необитаемом острове с реалистичной физикой и динамичной погодой. Стройте убежище, добывайте ресурсы и защищайтесь от опасностей.",
    genres: ["Simulation", "Adventure"],
    rating: 4.3,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/11194af62-0fe2-4da0-93f7-c67820d146f1.png",
  },
  {
    id: 7,
    title: "Horror Mansion",
    description:
      "Психологический хоррор в старинном особняке с жуткой атмосферой и неожиданными поворотами сюжета. Сможете ли вы выжить до рассвета?",
    genres: ["Horror", "Adventure"],
    rating: 4.7,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/1b024e05b-2a99-4a3d-83f5-f22e527d1372.png",
  },
  {
    id: 8,
    title: "Adventure Quest",
    description:
      "Классическое приключение с поиском сокровищ и решением головоломок. Исследуйте древние храмы и раскрывайте тайны прошлого.",
    genres: ["Adventure", "Puzzle"],
    rating: 4.5,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/1f55d927b-7296-47c6-8ea6-98c9351dd41c.png",
  },
  {
    id: 9,
    title: "Strategy Empire",
    description:
      "Глобальная стратегия с пошаговыми сражениями и дипломатией. Постройте свою империю от маленького поселения до мировой державы.",
    genres: ["Strategy", "Simulation"],
    rating: 4.6,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/1f3859fb6-f414-4051-9a2a-f3372ddc1f4f.png",
  },
  {
    id: 10,
    title: "Casual Farm",
    description:
      "Расслабляющий фермерский симулятор с милой графикой и увлекательным геймплеем. Выращивайте урожай, разводите животных и украшайте свою ферму.",
    genres: ["Simulation", "Casual"],
    rating: 4.4,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/1d598794b-a885-4749-9330-413e64988aa0.png",
  },
  {
    id: 11,
    title: "Sports Champions",
    description:
      "Спортивный симулятор с множеством дисциплин и реалистичной физикой. Станьте чемпионом в футболе, баскетболе, теннисе и других видах спорта.",
    genres: ["Sports", "Casual"],
    rating: 4.2,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/19ae7ed88-bc33-44b7-a48d-c739716ba115.png",
  },
  {
    id: 12,
    title: "Space Explorer",
    description:
      "Исследуйте бескрайние просторы космоса в этом захватывающем симуляторе. Открывайте новые планеты, изучайте инопланетные формы жизни и стройте космические станции.",
    genres: ["Simulation", "Adventure"],
    rating: 4.7,
    image:
      "https://image.qwenlm.ai/public_source/efde04de-8f99-4dab-98c0-32e6925f6494/15b8b4759-ca52-47d4-b3c6-c9895104b26b.png",
...
:root {
  ...
  --muted: #9fb1c6;
  --accent: #6bd4ff;
  --accent-strong: #35b9f0;
  --accent-soft: rgba(107, 212, 255, 0.14);
  --gold: #ffcc66;
  --danger: #ff6f6f;
  --success: #7be495;
...
body {
  ...
  color: var(--text);
  background:
    radial-gradient(circle at top left, rgba(64, 119, 177, 0.3), transparent 30%),
    radial-gradient(circle at top right, rgba(107, 212, 255, 0.12), transparent 24%),
    linear-gradient(180deg, #0a1018 0%, #101824 100%);
  min-height: 100vh;
}
...
.section-card,
.game-hero-card {
  background: linear-gradient(180deg, rgba(24, 36, 51, 0.95), rgba(18, 28, 40, 0.98));
...
.match-badge {
  ...
  border: 1px solid rgba(107, 212, 255, 0.2);
  border-radius: 999px;
  padding: 8px 12px;
  width: fit-content;
}
...
.search-field input:focus {
  border-color: rgba(107, 212, 255, 0.45);
...
.primary-button {
  color: #06283a;
  background: linear-gradient(135deg, var(--accent), #8ce9ff);
}
...
.avatar {
  ...
  font-family: "Barlow", sans-serif;
  font-size: 24px;
  background: linear-gradient(135deg, rgba(107, 212, 255, 0.25), rgba(255, 204, 102, 0.2));
  border: 1px solid rgba(255, 255, 255, 0.08);
}
...
.modal-card {
  ...
  padding: 24px;
  border-radius: 22px;
  background: linear-gradient(180deg, #182433, #111923);
  border: 1px solid var(--line);
}
